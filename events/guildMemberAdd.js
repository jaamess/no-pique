...
module.exports = class extends Event {
    ...
    async run(member) {
        ...
        greetChannel.send(`<a:N1:657447252440252416><a:P1:657447252301840399>  **|  Bem vindo(a) <@${member.user.id}>! Leia as <#639319056343760918> e sinta-se em casa <a:pikachu_legal:644005135093202954>**`);
